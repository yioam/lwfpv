...
public class LWLogUtils {
    ...
    /** 日志输出时的TAG */
    private static String mTag = "lewei";
    /** 是否允许输出log */
...
//            LWFileUtil.writeFile(log + "\r\n", path, append);
    ...
    public static void outError(String lineMsg, String notLineMsg){
        if(false){
            e(lineMsg);
        }else{
            throw new RuntimeException(notLineMsg);
        }
    }
}
