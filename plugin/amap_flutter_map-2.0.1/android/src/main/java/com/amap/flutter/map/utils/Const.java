...
public class Const {
    ...
    public static final String METHOD_MAP_ADD_MARKER = "map#addMarker";
    public static final String METHOD_MAP_DRAW_TRAIL_FROM_SCREEN_LOCATION = "map#drawTrailFromScreenLocation";
    public static final String METHOD_MAP_CLEAR_ALL_MARKER = "map#clearAllMaker";
    public static final String METHOD_MAP_SET_MARKER_CLICK_TO_DEL = "map#setMarkerClickToDel";
    public static final String METHOD_MAP_FROM_SCREEN_LOCATION = "map#fromScreenLocation";
    public static final String METHOD_MAP_CLICK_LISTENER = "map#setOnMarkerClickListener";
    ...
    public static final String[] METHOD_ID_LIST_FOR_MAP = {
            ...
            METHOD_MAP_ADD_MARKER,
            METHOD_MAP_DRAW_TRAIL_FROM_SCREEN_LOCATION,
            METHOD_MAP_CLEAR_ALL_MARKER,
            METHOD_MAP_SET_MARKER_CLICK_TO_DEL,
            METHOD_MAP_FROM_SCREEN_LOCATION,
            METHOD_MAP_CLICK_LISTENER};
