...
import 'package:google_maps_flutter/src/method_channel/method_channel_google_maps_flutter.dart';
...
/// lewei  marker onTap
class LwMarkerTapEvent extends _PositionedMapEvent<void> {
  /// Build an MapTap Event triggered from the map represented by `mapId`.
  ///
  /// The `position` of this event is the LatLng where the Map was tapped.
  LwMarkerTapEvent(int mapId, LatLng position) : super(mapId, position, null);
}
