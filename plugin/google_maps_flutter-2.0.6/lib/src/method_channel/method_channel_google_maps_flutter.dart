...
import 'package:google_maps_flutter/google_maps_flutter_platform_interface.dart';
...
class MethodChannelGoogleMapsFlutter extends GoogleMapsFlutterPlatform {
  ...
  @override
  Stream<LwMarkerTapEvent> onLwMarkerTap({required int mapId}) {
    return _events(mapId).whereType<LwMarkerTapEvent>();
  }
  ...
  Future<dynamic> _handleMethodCall(MethodCall call, int mapId) async {
    switch (call.method) {
      ...
      case 'map#onTap':
        ...
        break;
      case 'map#markerTap':
        _mapEventStreamController.add(LwMarkerTapEvent(
          mapId,
          LatLng.fromJson(call.arguments['position'])!,
        ));
        break;
  ...
  @override
  Future<void> addCircle(Map<String, dynamic> map, {
    required int mapId,
  }) {
    return channel(mapId).invokeMethod<void>('map#addCircle', map);
  }

  @override
  Future<String?> addMarker(Map<String, dynamic> map, {
    required int mapId,
  }) {
    return channel(mapId).invokeMethod<String>('map#addMarker', map);
  }
  ...
  Future<void> clearMarker({
    ...
    return channel(mapId).invokeMethod<String>('map#clearMarker');
  }

  @override
  Future<String?> setMarkerClickToDel(Map<String, dynamic> map, {
    required int mapId,
  }) {
    return channel(mapId).invokeMethod<String>('map#setMarkerClickToDel', map);
  }

  @override
  Future<String?> drawTrailFromScreenLocation(Map<String, dynamic> map, {
    required int mapId,
  }) {
  ...
  Future<void> setOnMarkerClickListener({
    ...
    return channel(mapId).invokeMethod<String>('map#setOnMarkerClickListener');
  }
